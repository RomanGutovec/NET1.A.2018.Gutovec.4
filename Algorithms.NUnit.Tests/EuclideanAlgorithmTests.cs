...
namespace Algorithms.NUnit.Tests
{
    ...
    public class EuclideanAlgorithmTests
    {
        ...
        public int GCDEuclidMethodTest(int firstNumber, params int[] numberNext)
        => Algorithms.EuclideanAlgorithm.GCDEuclid(firstNumber, numberNext);

        [TestCase(0)]
        [TestCase(-5)]
        public void GCDEuclidMethodTest_AmountLessThen2_ArgumentException(int firstNumber, params int[] numberNext)
                => Assert.Throws<ArgumentException>(() => Algorithms.EuclideanAlgorithm.GCDEuclid(firstNumber, numberNext));

        [Test]
        public void GCDEuclidMethodTest_Null_ThrownNullReferenceException()
        => Assert.Throws<NullReferenceException>(() => Algorithms.EuclideanAlgorithm.GCDEuclid(5, null));
        ...
        public int GCDBinaryMethodTest(int firstNumber, params int[] numberNext)
        => Algorithms.EuclideanAlgorithm.GCDBinary(firstNumber, numberNext);

        [TestCase(15)]
        [TestCase(-8)]
        public void GCDBinaryMethodTest_AmountLessThen2_ArgumentException(int firstNumber, params int[] numberNext)
        => Assert.Throws<ArgumentException>(() => Algorithms.EuclideanAlgorithm.GCDRecursion(firstNumber, numberNext));

        [Test]
        public void GCDBinaryMethodTest_Null_ThrownNullReferenceException()
        => Assert.Throws<NullReferenceException>(() => Algorithms.EuclideanAlgorithm.GCDRecursion(-5, null));
        ...
        public int GCDRecursionMethodTest(int firstNumber, params int[] numberNext)
             => Algorithms.EuclideanAlgorithm.GCDRecursion(firstNumber, numberNext);

        [TestCase(0)]
        [TestCase(-5)]
        public void GCDRecursionMethodTest_AmountLessThen2_ArgumentException(int firstNumber, params int[] numberNext)
                => Assert.Throws<ArgumentException>(() => Algorithms.EuclideanAlgorithm.GCDRecursion(firstNumber, numberNext));
